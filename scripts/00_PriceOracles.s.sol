...
contract DeployOracles is EthereumScript {
  function getMatrixValuesV2() internal returns (uint256) {
    string[] memory inputs = new string[](2);
    inputs[0] = 'node';
    inputs[1] = 'scripts/generateMatrixv2.js';
    bytes memory matrix = vm.ffi(inputs);
    return abi.decode(matrix, (uint256));
  }

  function getMatrixValuesV1() internal returns (uint256) {
    string[] memory inputs = new string[](2);
    inputs[0] = 'node';
